...
<template>
    <div class="w-full bg-gray-800/50 border border-gray-700 rounded-xl p-6 shadow-lg">
        <h2 class="text-medium font-semibold text-gray-300 mb-4 border-b border-gray-700 pb-2">Métricas de Trader &
            Liquidez</h2>
        ...
        <div class="flex flex-wrap gap-6 justify-start">
            ...
            <div class="w-full md:w-1/3 min-w-[200px] p-3 border border-gray-700 rounded-lg bg-gray-900/40">
                ...
                <div class="h-1 bg-gray-700 mt-2 rounded-full">
                    <div :style="{ width: dominance.btc + '%' }"
                        class="h-1 rounded-full bg-gray-500 transition-all duration-500"></div>
                </div>
